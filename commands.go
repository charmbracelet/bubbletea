...
//
// Because we're synchronizing ticks with the system clock, the tick may wait
// the full duration before running. For example, if we specify one minute and
// the clock is at 12:34:20 then the next tick will happen at 12:35:00, 40
// seconds later.
//
